...
class model_class(object):
    def __init__(self, args):
        ...
        input_data = datagenerate.input_data(args=self.args)
        ...
        feature_list = [input_data.l_embed1, input_data.l_embed2, \
                        input_data.l_m_net_embed, input_data.l_d_net_embed, input_data.l_ref_net_embed, \
                        input_data.l_net_embed, input_data.d_net_embed, input_data.d_text_embed, \
                        input_data.m_net_embed, input_data.m_text_embed]
        ...
        self.model = tools.HetAgg(args, feature_list, d_neigh_list_train, l_neigh_list_train, m_neigh_list_train, \
                                  d_train_id_list, l_train_id_list, m_train_id_list)
    ...
    def model_train(self):
        ...
        for iter_i in range(self.args.train_iter_n):
            ...
            if iter_i % self.args.save_model_freq == 0:#  save_model_freq=2
